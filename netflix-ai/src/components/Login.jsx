 ...
 const Login = () => {
  ...
  return (
    <div>
     ...
     <form className="absolute mx-auto left-0 right-0 bg-black w-[30%] h-4/5 bg-opacity-80 p-12 my-36 rounded-lg">
     ...
     {!isSignIn && <input type="text" id="name"  placeholder="Full Name" className="p-2 m-2 w-full h-14 rounded-sm placeholder-gray bg-transparent border"/>}
      ...
      <input type="email" id="emailId"  placeholder="Email or mobile number" className="p-2 m-2 w-full h-14 rounded-sm placeholder-gray bg-transparent border"/>
    ...
    <>
      New to Netflix?{' '}
      <a className="font-semibold text-cyan-50 hover:text-fuchsia-300" href="#">
        Sign up now.
      </a>
    </>
